...
if (keyword != null && !keyword.trim().isEmpty()) {
    ...
    try {
        ...
        String sql = "SELECT e.id, e.name, e.gender, e.age, e.phone, e.email, p.position_name " +
        ...
        out.println("<tr><th>ID</th><th>姓名</th><th>性别</th><th>年龄</th><th>电话</th><th>邮箱</th><th>职位</th></tr>");
        ...
        if (!hasResult) {
            out.println("<tr><td colspan='7'>未找到符合条件的员工</td></tr>");
        }
        out.println("</table>");
